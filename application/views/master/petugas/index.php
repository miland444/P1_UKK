            ...
            <div class="modal-content">
                ...
                <form method="post" action="<?= base_url('masterdata/petugas_edit') ?>">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="#" class="btn btn-warning text-dark" data-toggle="modal" data-dismiss="modal" data-target="#modalPassword<?= $p->ID_PETUGAS ?>"><i class="fas fa-key"></i> Ubah Kata Sandi?</a>
            ...
            <div class="modal-content">
                ...
                <form method="post" action="<?= base_url('masterdata/petugas_pass') ?>">
                    ...
                    <div class=" modal-footer">
                        ...
                        <a href="#" class="btn btn-warning text-dark" data-toggle="modal" data-dismiss="modal" data-target="#modalEdit<?= $p->ID_PETUGAS ?>"><i class="fas fa-arrow-left"></i> Kembali?</a>
