...
<aside class="main-sidebar sidebar-dark-default elevation-4">
    ...
    <a href="<?= base_url('user') ?>" class="brand-link">
        <i class="fas fa-school fa-2x mr-2 ml-2"></i>
        <span class="brand-text font-weight-bold" style="position: relative; top: -5px; ">Aplikasi SPP</span>
    </a>
